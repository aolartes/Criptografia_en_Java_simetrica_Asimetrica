...
public class VistaUsers extends javax.swing.JFrame  {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        CSimetrico objetoSimetrico = new CSimetrico();
        try {
            objetoSimetrico.decryptPassword(txtcodigousuario,txtpassword,txtencrypted);        // TODO add your handling code here:
        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(VistaUsers.class.getName()).log(Level.SEVERE, null, ex);
        }
